...
cuerpo.push(p('Se ensayó también un modelo ampliado con las dos variables ópticas que aportan los libros de espectros, la absorción del material no algal y la de la materia orgánica disuelta a 443 nm. Sobre las 46 estaciones con las cinco variables, el coeficiente de determinación sube de 0,119 a 0,262, y el único término significativo es la absorción de la materia orgánica disuelta, con probabilidad de 0,009. La mejora es real pero sigue lejos del umbral fijado.'));
